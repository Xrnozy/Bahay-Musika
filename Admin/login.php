...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result['success']) {
            if ($result['user']['role'] === 'head_admin') {
                header('Location: admin.php');
            } else if ($result['user']['role'] === 'content_manager') {
                header('Location: content-manager.php');
            } else if ($result['user']['role'] === 'social_manager') {
                header('Location: social-manager.php');
            } else {
    ...
    <style>
        ...
        * {
        ...
        .login-header::before {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(45deg, rgba(53, 53, 53, 0.3) 0%, transparent 100%);
        }
