            ...
            <div class="add-member">
                ...
                <div class="input-main">
                    <div class="input-cont">
                        <input class="input-name" type="text" name="name" placeholder="News Title">
                        <input class="input-name" type="date" name="date" placeholder="News Date">
                        <input class="input-name" type="text" name="Category" placeholder="News Location">
                        <input class="input-name" type="text" name="Category" placeholder="Facebook News Link">
                        <textarea class="input-name" name="description" id="" cols="30" rows="5" placeholder="News Description"></textarea>
