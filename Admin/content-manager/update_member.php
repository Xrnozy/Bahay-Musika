...
<<<<<<< HEAD
                            ...
                            <input class="info-input" type="text" name="extName"
                                value="<?= htmlspecialchars($user['extName'] ?? '') ?>" placeholder="Ext. Name" />
                            <input class="info-input" type="date" name="dob"
                                value="<?= htmlspecialchars($user['dob'] ?? '') ?>" placeholder="Date of Birth" />
                            <input class="info-input" type="tel" name="phone"
                                value="<?= htmlspecialchars($user['phone'] ?? '') ?>" placeholder="Phone Number" />
                            <input class="info-input" type="text" name="street"
                                value="<?= htmlspecialchars($user['street'] ?? '') ?>" placeholder="Street Address" />
                            <input class="info-input" type="text" name="city"
                                value="<?= htmlspecialchars($user['city'] ?? '') ?>" placeholder="City" />
                            <input class="info-input" type="text" name="state"
                                value="<?= htmlspecialchars($user['state'] ?? '') ?>" placeholder="State/Province" />
                            <input class="info-input" type="text" name="zip"
                        ...
                        <div class="profile-image-section layout-input">
                            <section class="upload-container">
                                <div class="upload-wrapper">
                                    <div x-data="imageData('<?= htmlspecialchars($user['profile_image'] ?? '') ?>')"
                                        ...
                                        <div class="upload-controls flex items-center">
                                            ...
                                            <div class="filename-display text-sm text-gray-500 mx-2">
                                                ...
                                                <button x-show="fileName" @click="clearPreview($refs)" type="button"
                                                    class="remove-image-btn" aria-label="Remove image">
