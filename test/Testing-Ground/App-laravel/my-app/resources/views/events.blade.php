...
<html>
  <head>
    ...
    <script src="assets/js/antiZoomIn.js"></script>
                  ...
                  <div class="slick-track" style="opacity: 1">
                    <div class="container-desc-per icymi">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-icymi"
                            >October 19 2024</span
                          >
                          <p class="event-title event-title-icymi">
                            ICYMI:
                            <i
                              >The capabilities building program and values
                    ...
                    <div class="container-desc-per baton">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-baton"
                            >August 31 2024
                          </span>
                    ...
                    <div class="container-desc-per sagip">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-sagip"
                            >July 27 2024</span
                          >
                    ...
                    <div class="container-desc-per school">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-school"
                            >July 21 2024</span
                          >
                    ...
                    <div class="container-desc-per pray">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-pray"
                            >March 17 2024
                          </span>
                    ...
                    <div class="container-desc-per values">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-values"
                    ...
                    <div class="container-desc-per hiv">
                      <div class="event-description-item slick-slide">
                        <div class="time">
                          <span class="date-label date-label-hiv"
                            >June 2 2024</span
                          >
